// ============================================================
//  FIX 1 of 4  -  CAST PHOTOS
//
//  File to replace:  Sources/Library/MediaDetailView.swift
//  Action: open that file on GitHub, select all, paste this in, commit.
//  No other file changes. Nothing else in the app is affected.
//
//  Why cast photos were missing: MetadataService already downloads
//  profile_path for every actor and stores it in CastMember.profileURL.
//  The detail view simply never used it, it only drew the actor's name
//  in a grey capsule. This file draws the real photo.
// ============================================================
